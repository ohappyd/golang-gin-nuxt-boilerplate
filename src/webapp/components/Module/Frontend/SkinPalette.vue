...
<template>
<ul class="swatch-list centerflipcards">
    <li class="swatch  opacity-8"
        :style2="getStyleColor(skin.class, 'theme1inv')"
        ...
        <div class="square-flip">
            <div class="square">
                ...
                <div class="square-container"
                    :style="getStyleColor(skin.class, 'theme1inv')">
                    <p class="text-weight-bold h2 text-uppercase"
                        :class="textClass">
                        {{skin.name}}
                    </p>
                    <div class="swatch-color p-2"
                        :style="getStyleColor(skin.class, 'theme1inv')"
                        :class="'skin-'+skin.class">
                        <div class="item-color"
                            :style="getStyleColor(skin.class, 'primary')"> P </div>
                        <div class="item-color"
                            :style="getStyleColor(skin.class, 'secondary')">S </div>
                        <div class="item-color"
                            :style="getStyleColor(skin.class, 'theme1')">T </div>

                    </div>
                    <div class="swatch-info p-2"
                        :style="getStyleColor(skin.class, 'theme1inv')">
                        <div class="d-flex">
                            <div v-for="(variant, i) in otherVariants"
                                class="flex-grow-1 other-colors"
                                :style="getStyleColor(skin.class, variant)"
                                :key="i">
            ...
            <div class="square2"
                style="background-image: url('/img/screen/dark.png')">
                <div class="square-container2 d-flex">

                    <a :href="'/admin/dashboard/?skin='+skin.class"
                        target="_blank"
                        class="boxshadow btn btn-primary m-auto">View Demo</a>
                </div>
                <div class="flip-overlay" />
            </div>
        </div>
...
export default {
  ...
  props: {
    textClass: { type: String, default: 'text-dark' },
    skins: {
      type: Array,
      default: () => [{
        name: 'Purple',
  ...
  methods: {
    getVariablesColors (skin) {
      return themeColors(skin)
    },

    getStyleColor (skin, variant) {
      const variableColors = this.getVariablesColors(skin)
      return {
        'background-color': variableColors[variant]
      }
    },

    getStyleTextColor (skin, variant) {
      const variableColors = this.getVariablesColors(skin)
      return {
        'color': variableColors[variant]
      }
    }
  ...
  data () {
    return {
      otherVariants: ['info', 'success', 'warning', 'danger', 'light', 'dark']
    }
  }

...
export const itemMixin = {
  ...
  methods: {
    ...
    clickEvent (event, mobileItem) {
      ...
      if ((this.isCollapsed || this.isComptacted) && this.firstItem && !this.item.child) {
        this.$parent.$emit('clickItem')
      }

      if (!mobileItem && this.item.child) {
        if ((this.isCollapsed || this.isComptacted) && this.firstItem) {
          event.preventDefault()
          return
        }
      ...
      } else if (!mobileItem && !(this.isCollapsed || this.isComptacted) && this.firstItem && !this.item.child) {
        this.emitActiveShow(null)
      }
    }
  },
...
export const animationMixin = {
  methods: {
    ...
    expandBeforeLeave (el) {
      if (this.isCollapsed || this.isComptacted) {

...
import skinDefault from '@/styles/variables/base/_default-skin.scss'

import skinBlue from '@/styles/variables/skin/_blue.scss'
import skinBlueLight from '@/styles/variables/skin/_blue-light.scss'
import skinPurple from '@/styles/variables/skin/_purple.scss'
import skinRed from '@/styles/variables/skin/_red.scss'
import skinGrey from '@/styles/variables/skin/_grey.scss'
import skinGreen from '@/styles/variables/skin/_green.scss'
import skinMaterial from '@/styles/variables/skin/_material.scss'

import skinDarkBlue from '@/styles/variables/skin/_dark-blue.scss'
import skinDarkGolden from '@/styles/variables/skin/_dark-golden.scss'
import skinDarkGrey from '@/styles/variables/skin/_dark-grey.scss'
import skinDarkPurple from '@/styles/variables/skin/_dark-purple.scss'
import skinDarkMaterial from '@/styles/variables/skin/_dark-material.scss'

import skinGreyGolden from '@/styles/variables/skin/_grey-golden.scss'
import skinGreyMaterial from '@/styles/variables/skin/_grey-material.scss'
import skinBackImage from '@/styles/variables/skin/_back-image.scss'
import skinColorPurpleAir from '@/styles/variables/skin/_color-purple-air.scss'
import skinColorDarkSky from '@/styles/variables/skin/_color-dark-sky.scss'
import skinColorCarbon from '@/styles/variables/skin/_color-carbon.scss'
